    ...
    def get_name_variations_info(self, obj=None):
        ...
        if not variations:
            return format_html(
                ...
                '<p style="margin: 0; color: #666;"><strong>Examples:</strong></p>'
                '<ul style="margin: 5px 0 0 20px; color: #666;">'
                '<li><strong>Numbered events:</strong> UFC 300, UFC 300: Pereira vs. Hill</li>'
                '<li><strong>Fight Nights:</strong> UFC Fight Night 245, UFC on ESPN+ 103, UFC Vegas 99</li>'
                '<li><strong>Pay-per-views:</strong> UFC 299: O\'Malley vs. Vera 2</li>'
                '</ul>'
                '</div>'
            )
